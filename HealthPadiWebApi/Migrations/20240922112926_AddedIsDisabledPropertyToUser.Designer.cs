...
namespace HealthPadiWebApi.Migrations
{
    ...
    [Migration("20240922112926_AddedIsDisabledPropertyToUser")]
    partial class AddedIsDisabledPropertyToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthPadiWebApi.Models.Feed", b =>
                {
            ...
            modelBuilder.Entity("HealthPadiWebApi.Models.HealthUpdate", b =>
                {
            ...
            modelBuilder.Entity("HealthPadiWebApi.Models.Report", b =>
                {
                    b.HasOne("HealthPadiWebApi.Models.User", "User")
                        .WithMany("Reports")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("HealthPadiWebApi.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
